            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-12 text-center mb-4">
                        <h3>โครงการบริจาคของ คณะพยาบาลศาสตร์</h3>
                    </div>
                    <?php
                    require_once 'connection.php';
                    $stmt = $conn->prepare("SELECT * FROM faculty ORDER BY id ASC");
                    $stmt->execute();
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-5">
                            <div class="custom-block-wrap">
                                ...
                                <div class="custom-block">
                                    <div class="custom-block-body" style="height: 100px;">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">กรอกรายละเอียด บริจาคของ คณะพยาบาลศาสตร์</h1>
                    ...
                    <div class="modal-body">
                        <form id="dynamicForm" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div id="donationOptions" class="row" style="display: none;">
                                <div class="col-md-10 col-12 mb-3">
                                    <input class="form-check-input" type="radio" name="optionsedo" id="optionsedo1" value="บริจาคเพื่อเป็นทุนการศึกษาของนักศึกษาพยาบาล คณะพยาบาลศาสตร์ มช." checked>
                                    <label class="form-check-label" for="optionsedo1">
                                        บริจาคเพื่อเป็นทุนการศึกษาของนักศึกษาพยาบาล คณะพยาบาลศาสตร์ มช.
                                    </label>
                                </div>
                                <div class="col-md-12 col-12 mb-3">
                                    <input class="form-check-input" type="radio" name="optionsedo" id="optionsedo2" value="บริจาคเพื่อจัดหาวัสดุอุปกรณ์การศึกษา จัดสร้างอาคารและปรับปรุงอาคารเรียนคณะพยาบาลศาสตร์ มช.">
                                    <label class="form-check-label" for="optionsedo2">
                                        บริจาคเพื่อจัดหาวัสดุอุปกรณ์การศึกษา จัดสร้างอาคารและปรับปรุงอาคารเรียนคณะพยาบาลศาสตร์ มช.
                                    </label>
                                </div>
                            </div>
                            <div class="row">
